...
async updateEndDateOnResourcesMap(codColab,codServ,codCliente,codLinServ,periodo){
 ...
 async showAssignments(codServ){
  const query=`SELECT cod_asignacion,asignacion_recursos.cod_servicio,asignacion_recursos.cod_colaborador,puesto.puesto,colaborador.nivel,CONCAT(nombres,' ',apellido_pat,' ',apellido_mat) AS nombres_apellidos,
